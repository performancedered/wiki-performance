...
WITH FEC AS (SELECT/*+ materialize */ FECHA 
   ...
   BTS_BH AS  (SELECT/*+ materialize */ FECHA, COUNT(*) CANTIDAD
             FROM MULTIVENDOR_BTS_BH 
             WHERE FECHA BETWEEN TO_DATE('&FECHA_DESDE','DD.MM.YYYY') 
             AND TO_DATE('&FECHA_HASTA','DD.MM.YYYY') + 86399/86400 GROUP BY FECHA
             ),
   BSC AS  (SELECT/*+ materialize */ FECHA, COUNT(*) CANTIDAD
             FROM MULTIVENDOR_BSC_BH 
             WHERE FECHA BETWEEN TO_DATE('&FECHA_DESDE','DD.MM.YYYY') 
             AND TO_DATE('&FECHA_HASTA','DD.MM.YYYY') + 86399/86400 GROUP BY FECHA
             ),
   ALM AS (SELECT/*+ materialize */ FECHA, COUNT(*) CANTIDAD 
             FROM MULTIVENDOR_ALM_BH 
             WHERE FECHA BETWEEN TO_DATE('&FECHA_DESDE ','DD.MM.YYYY') 
             AND TO_DATE('&FECHA_HASTA','DD.MM.YYYY')+ 86399/86400 GROUP BY FECHA
             ),
   MARKET AS(SELECT/*+ materialize */ FECHA, COUNT(*) CANTIDAD
             FROM MULTIVENDOR_MARKET_BH 
             WHERE FECHA BETWEEN TO_DATE('&FECHA_DESDE ','DD.MM.YYYY') 
             AND TO_DATE('&FECHA_HASTA ','DD.MM.YYYY')+ 86399/86400 GROUP BY FECHA
             ),
   PAIS AS (SELECT/*+ materialize */ FECHA, COUNT(*) CANTIDAD
             FROM MULTIVENDOR_PAIS_BH 
             WHERE FECHA BETWEEN TO_DATE('&FECHA_DESDE','DD.MM.YYYY') 
             AND TO_DATE('&FECHA_HASTA','DD.MM.YYYY')+ 86399/86400 GROUP BY FECHA
             )
SELECT FEC.FECHA FECHA,
...
WITH FEC AS (SELECT FECHA 
   ...
   BTS_DAY AS  (SELECT /*+ materialize */FECHA, COUNT(*) CANTIDAD
             FROM MULTIVENDOR_GPRS_DAY 
             WHERE FECHA BETWEEN TO_DATE('&FECHA_DESDE','DD.MM.YYYY') 
             AND TO_DATE('&FECHA_HASTA','DD.MM.YYYY') + 86399/86400 GROUP BY FECHA
             ),
   BSC AS  (SELECT /*+ materialize */FECHA, COUNT(*) CANTIDAD
             FROM MULTIVENDOR_GPRS_BSC_DAY 
             WHERE FECHA BETWEEN TO_DATE('&FECHA_DESDE','DD.MM.YYYY') 
             AND TO_DATE('&FECHA_HASTA','DD.MM.YYYY') + 86399/86400 GROUP BY FECHA
             ),
   ALM AS (SELECT /*+ materialize */FECHA, COUNT(*) CANTIDAD 
             FROM MULTIVENDOR_GPRS_ALM_DAY 
             WHERE FECHA BETWEEN TO_DATE('&FECHA_DESDE ','DD.MM.YYYY') 
             AND TO_DATE('&FECHA_HASTA','DD.MM.YYYY')+ 86399/86400 GROUP BY FECHA
             ),
   MARKET AS(SELECT /*+ materialize */FECHA, COUNT(*) CANTIDAD
             FROM MULTIVENDOR_GPRS_MKT_DAY 
             WHERE FECHA BETWEEN TO_DATE('&FECHA_DESDE ','DD.MM.YYYY') 
             AND TO_DATE('&FECHA_HASTA ','DD.MM.YYYY')+ 86399/86400 GROUP BY FECHA
             ),
   PAIS AS (SELECT /*+ materialize */FECHA, COUNT(*) CANTIDAD
             FROM MULTIVENDOR_GPRS_PAIS_DAY 
             WHERE FECHA BETWEEN TO_DATE('&FECHA_DESDE','DD.MM.YYYY') 
             AND TO_DATE('&FECHA_HASTA','DD.MM.YYYY')+ 86399/86400 GROUP BY FECHA
             )
SELECT FEC.FECHA FECHA,
       BTS_DAY.CANTIDAD GPRS_DAY,
       BSC.CANTIDAD BSC,
       ALM.CANTIDAD ALM,
       MARKET.CANTIDAD MKT,
       PAIS.CANTIDAD PAIS
...
WITH FEC AS (SELECT/*+ materialize */ FECHA 
   ...
   BTS_BH AS  (SELECT /*+ materialize */FECHA, COUNT(1) CANTIDAD
             FROM MULTIVENDOR_GPRS_BH 
             WHERE FECHA BETWEEN TO_DATE('&FECHA_DESDE','DD.MM.YYYY') 
             AND TO_DATE('&FECHA_HASTA','DD.MM.YYYY') + 86399/86400 GROUP BY FECHA
             ),
   BSC AS  (SELECT /*+ materialize */FECHA, COUNT(1) CANTIDAD
             FROM MULTIVENDOR_GPRS_BSC_BH 
             WHERE FECHA BETWEEN TO_DATE('&FECHA_DESDE','DD.MM.YYYY') 
             AND TO_DATE('&FECHA_HASTA','DD.MM.YYYY') + 86399/86400 GROUP BY FECHA
             ),
   ALM AS (SELECT /*+ materialize */FECHA, COUNT(1) CANTIDAD 
             FROM MULTIVENDOR_GPRS_ALM_BH 
             WHERE FECHA BETWEEN TO_DATE('&FECHA_DESDE ','DD.MM.YYYY') 
             AND TO_DATE('&FECHA_HASTA','DD.MM.YYYY')+ 86399/86400 GROUP BY FECHA
             ),
   MARKET AS(SELECT/*+ materialize */ FECHA, COUNT(1) CANTIDAD
             FROM MULTIVENDOR_GPRS_MKT_BH 
             WHERE FECHA BETWEEN TO_DATE('&FECHA_DESDE ','DD.MM.YYYY') 
             AND TO_DATE('&FECHA_HASTA ','DD.MM.YYYY')+ 86399/86400 GROUP BY FECHA
             ),
   PAIS AS (SELECT/*+ materialize */ FECHA, COUNT(1) CANTIDAD
             FROM MULTIVENDOR_GPRS_PAIS_BH 
             WHERE FECHA BETWEEN TO_DATE('&FECHA_DESDE','DD.MM.YYYY') 
             AND TO_DATE('&FECHA_HASTA','DD.MM.YYYY')+ 86399/86400 GROUP BY FECHA
             )
SELECT FEC.FECHA FECHA,
