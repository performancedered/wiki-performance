...
BEGIN
  ...
  G_PARTITION_MGMT.P_TRUNCATE_PARTITION_HOUR('UMTS_UL_INTFRNC_WCEL_HOUR',P_FECHA_DESDE, P_FECHA_HASTA);
  P_UMTS_UL_INTFRNC_HOUR_INS(P_FECHA_DESDE, P_FECHA_HASTA);
...
BEGIN
  ...
  G_PARTITION_MGMT.P_TRUNCATE_PARTITION_DAY('TABLERO_UMTS_ULINTFN_WCEL_DAY',P_FECHA_DESDE, P_FECHA_HASTA);
  P_TABLERO_UMTS_ULINTFRNC_DAY(P_FECHA_DESDE, P_FECHA_HASTA);
...
BEGIN
  ...
  G_PARTITION_MGMT.P_TRUNCATE_PARTITION_DAY('TABLERO_UMTS_ULINTFN_WCEL_WEEK',P_FECHA_DESDE, P_FECHA_HASTA);
  P_TABLERO_UMTS_ULINTFRNC_WEEK(P_FECHA_DESDE, P_FECHA_HASTA);
