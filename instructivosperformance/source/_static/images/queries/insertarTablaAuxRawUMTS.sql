-- SELECT
--SELECT * FROM AUX_UMTS_C_ALL_FCTRL_RAW

-- Control Primer Circulo
DROP TABLE AUX_UMTS_C_ALL_FCTRL_RAW PURGE;

--TAB=umtsCntRawOssRC1
CREATE TABLE AUX_UMTS_C_ALL_FCTRL_RAW TABLESPACE TBS_AUXILIAR PCTFREE 5 PCTUSED 95 AS
SELECT RFC.FECHA,
       'OSSRC1' OSSRC,
...
--TAB=umtsCntRawOssRC2
INSERT INTO AUX_UMTS_C_ALL_FCTRL_RAW
--DROP TABLE AUX_UMTS_C_ALL_FCTRL_RAW PURGE;
--CREATE TABLE AUX_UMTS_C_ALL_FCTRL_RAW TABLESPACE TBS_AUXILIAR PCTFREE 5 PCTUSED 95 AS
SELECT RFC.FECHA,
       'OSSRC2' OSSRC,
